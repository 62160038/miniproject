  ...
  <div class="modal-dialog">
    <div class="modal-content text-center">
      ...
      <div class="modal-footer">
        <a href="edit.php?number=<?=$index_number?>" type="button" class="btn btn-secondary">ยกเลิก</a> 
        <a href="delete.php?number=<?=$index_number?>" type="button" class="btn btn-primary">ยืนยัน</a> 
      </div>
    </div>
  </div>
</div>
