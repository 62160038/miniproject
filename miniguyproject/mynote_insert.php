        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <?php 
                        echo '<a href="mynote_confirm_edit.php?number=' . $index_number . '" class="fas fa-save col-md-3 text-center" style="font-size: 2.5em; "></a>'
                    ?> 
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content text-center">
      ...
      <div class="modal-footer">
        <a href="mynote_edit.php?number=<?=$index_number?>" type="button" class="btn btn-secondary">ยกเลิก</a> 
        <a href="mynote_confirm_delete.php?number=<?=$index_number?>" type="button" class="btn btn-primary">ยืนยัน</a> 
      </div>
    </div>
  </div>
</div>
